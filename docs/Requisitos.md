...
- **RF-02.4:** O cálculo de score deve ocorrer de forma assíncrona (background tasks), sem impacto no tempo de resposta da API.
...
- **RF-05.1:** O sistema deve expor os 10 repositórios com maior score da semana como "featured".
- **RF-05.2:** A seção Featured deve ser atualizada a cada 24 horas via task agendada.
...
- **RNF-03.1:** Workers Celery devem ser escaláveis horizontalmente sem alteração de código.
- **RNF-03.2:** A arquitetura deve suportar o processamento de **10.000+ repositórios** sem degradação.
...
- **RNF-06.3:** Erros de tasks Celery devem ser registrados com stack trace completo.
